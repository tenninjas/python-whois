...
def query(domain, force=0, cache_file=None, slow_down=0, ignore_returncode=0, robust_query=0):
    """
    ...
    while 1:
        pd = do_parse(do_query(d, force, cache_file, slow_down, ignore_returncode, robust_query), tld)
